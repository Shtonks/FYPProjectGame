...
public class EnemyAI : MonoBehaviour
{
    ...
    //     shipController = GetComponent<TopDownShipController>();
    // }
    ...
    // private void Update() {
    //     aiPath.destination = roamingPos;

    //     // When we reach this dist, calc new roamPos
    //     float reachedRoamingDist = 0f;
    //     if (Vector2.Distance(transform.position, roamingPos) < reachedRoamingDist) {
    //         aiPath.destination = GetRoamingPos();
    //     }
    // }
